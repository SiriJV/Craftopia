...
import '../src/components/chest/chest';
import '../src/components/lantern/lantern';
import './components/main/dropdown/dropdown';
import './minigames/gamepage';
import './components/main/searchables/items';
